...
#ifndef SUNDIAL_HTTP_PARSER_H_INCLUDED_
#define SUNDIAL_HTTP_PARSER_H_INCLUDED_
...
SUNDIAL_API size_t         http_parser_run(http_parser_t *, http_parse_hooks_t *, 
    const char *, size_t);
SUNDIAL_API int            http_parser_should_keep_alive(http_parser_t * p);
SUNDIAL_API http_scheme_e  http_parser_get_scheme(http_parser_t *);
SUNDIAL_API http_method_e  http_parser_get_method(http_parser_t *);
SUNDIAL_API const char    *http_parser_get_methodstr(http_parser_t *);
SUNDIAL_API void           http_parser_set_major(http_parser_t *, unsigned char);
SUNDIAL_API void           http_parser_set_minor(http_parser_t *, unsigned char);
SUNDIAL_API unsigned char  http_parser_get_major(http_parser_t *);
SUNDIAL_API unsigned char  http_parser_get_minor(http_parser_t *);
SUNDIAL_API unsigned char  http_parser_get_multipart(http_parser_t *);
SUNDIAL_API unsigned int   http_parser_get_status(http_parser_t *);
SUNDIAL_API uint64_t       http_parser_get_content_length(http_parser_t *);
SUNDIAL_API uint64_t       http_parser_get_total_bytes_read(http_parser_t *);
SUNDIAL_API http_parse_error_e http_parser_get_error(http_parser_t *);
SUNDIAL_API const char   * http_parser_get_strerror(http_parser_t *);
SUNDIAL_API void         * http_parser_get_userdata(http_parser_t *);
SUNDIAL_API void           http_parser_set_userdata(http_parser_t *, void *);
SUNDIAL_API void           http_parser_init(http_parser_t *, http_type_e);
SUNDIAL_API http_parser_t* http_parser_new(void);


ENV_CPP(})


#endif /* SUNDIAL_HTTP_PARSER_H_INCLUDED_ */
